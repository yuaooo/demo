...
namespace TDSTK {
	...
	public class PerkDB : MonoBehaviour {
		...
		public static PerkDB LoadDB(){
			GameObject obj=Resources.Load("DB_TDSTK/DB_Perk", typeof(GameObject)) as GameObject;
		...
		public static List<Perk> LoadClone(){
			...
			private static GameObject CreatePrefab(){
				...
				GameObject prefab=PrefabUtility.CreatePrefab("Assets/TDSTK/Resources/DB_TDSTK/DB_Perk.prefab", obj, ReplacePrefabOptions.ConnectToPrefab);
